...
var graphRenderer = function graphRenderer() {
  ...
  var entities = ["Name", "Type", "PrimaryKey", "CodeSystem", "Code", "Count"];
  ...
  var render = function render(id, $container, visualization) {
    ...
    //var nodeInfo = function nodeInfo(svg, styles) {
    //  return;
    //};
    ...
    console.log(legend(svg, existingStyles));
    //nodeInfo(svg, existingStyles);
    var zoomHandlers = {};
